...
export default {
  ...
  methods: {
    ...
    edit(data) {
      ...
      _this.getRoleLevel()
      _this.roleIds = []
      _this.form = { id: data.id,realName:data.realName, username: data.username, phone: data.phone, email: data.email, enabled: data.enabled.toString(), roles: [], dept: { id: data.dept.id }, job: { id: data.job.id }}
