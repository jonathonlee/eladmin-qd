    ...
    <el-row :gutter="20">
      ...
      <el-col :xs="17" :sm="18" :md="20" :lg="20" :xl="20">
        ...
        <div class="head-container">
          ...
          <el-select v-model="query.type" clearable placeholder="周次" class="filter-item" style="width: 130px">
...
export default {
  ...
  data() {
    return {
      ...
      queryTypeOptions: [
        { key: '0', display_name: '本周' },
        { key: '1', display_name: '上周' }
      ],
      // enabledTypeOptions: [
  ...
  methods: {
    ...
    checkPermission,
    beforeInit() {
      this.url = 'api/users/initUserCountList'
      debugger
      const sort = 'id,desc'
